...
<body>
    <div class="container">
        <h1><i class="bi bi-cash"></i> Deposit</h1>
        <form action="DepositServlet" method="post">
            <label for="amount"><i class="bi bi-currency-rupee"></i> Amount to Deposit:</label>
            <input type="number" id="amount" name="amount" required>
            <button type="submit" class="submit-button"><i class="bi bi-bank"></i> Deposit</button>
        </form>
        <div class="message">
